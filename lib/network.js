...
/**
 * 物理链路是否 up：carrier + operstate 双读，避免单读 carrier 拔线不更新、或与 WiFi 状态不同步的误判。
 */
 ...
 * - CLAWD_ETH_IFACE：只读该口
 * - 否则只认 end0、eth0（存在则仅用其 sysfs，链路 down 即灭，不再退回「任一带 carrier 口」以免跟 WiFi 耦合）
